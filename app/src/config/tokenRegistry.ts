...
const tokenRegistry = {
  dots2sCcmVzd9f2pk8pL7z8dokD9Cyt8cLAPfhrwETa: {
    chainId: 101,
    address: 'dots2sCcmVzd9f2pk8pL7z8dokD9Cyt8cLAPfhrwETa',
    symbol: 'DOTS',
    name: 'The Kiddos Token',
    decimals: 9,
    logoURI: '/resources/kiddos_token.png',
    tags: [],
    extensions: {
      website: 'https://union.kiddoslabs.io/',
      serumV3Usdc: '9wFFyRfZBsuAha4YcuxcXLKwMxJR43S7fPfQLusDBzvT',
      serumV3Usdt: 'HWHvQhFmJB3NUcu1aihKmrKegfVxBEHzwVX6yZCKEsi1',
      coingeckoId: 'solana',
      imageURI: '/resources/kiddos_token.png',
    },
  },
